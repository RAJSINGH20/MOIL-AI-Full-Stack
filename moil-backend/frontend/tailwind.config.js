  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        'motion-card': '0 18px 42px rgba(15, 23, 42, 0.12), 0 5px 0 rgba(5, 150, 105, 0.08)',
        'map-frame': '0 0 0 5px rgba(16, 185, 129, 0.08), 0 12px 28px rgba(15, 23, 42, 0.12)',
        'map-frame-hover': '0 0 0 7px rgba(16, 185, 129, 0.12), 0 18px 34px rgba(15, 23, 42, 0.16)',
      },
      backgroundImage: {
